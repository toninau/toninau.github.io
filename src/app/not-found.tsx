...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center">
      <div aria-hidden="true" className="flex select-none flex-col items-center justify-center">
        <span className="text-nowrap text-[14rem] leading-tight tracking-tighter text-stone-200">
          : (
        </span>
        <span className="font-mono text-4xl tracking-tighter text-stone-200">404</span>
      </div>
