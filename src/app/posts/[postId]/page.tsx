...
export default async function PostPage(props: PostPageProps) {
  ...
  return (
    <article>
      ...
      <section
        className="prose prose-stone min-w-full break-words dark:prose-invert prose-headings:font-semibold prose-headings:tracking-tighter prose-p:font-serif prose-pre:px-0 prose-ol:font-serif prose-ul:font-serif"
