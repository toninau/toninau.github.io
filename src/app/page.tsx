  ...
  return (
    <div className="flex content-center justify-center px-4 sm:px-6">
      <main className="w-full max-w-screen-sm">
        ...
        <article>
          <h2 className="mb-8 mt-6 text-3xl font-semibold tracking-tighter text-stone-900 sm:text-4xl dark:text-white">
            About
          </h2>
          <p className="my-5 font-serif text-sm text-stone-700 sm:text-base dark:text-stone-300">
        ...
        <article>
          <h2 className="mb-8 mt-12 text-3xl font-semibold tracking-tighter text-stone-900 sm:text-4xl dark:text-white">
            Posts
          </h2>
          {frontPagePosts.map((post) => (
            <article className="my-6" key={post.postId}>
              <h3 className="my-2 text-xl font-medium tracking-tighter text-stone-900 sm:text-2xl dark:text-white">
              ...
              <p className="my-1 font-serif text-sm text-stone-700 sm:text-base dark:text-stone-300">
